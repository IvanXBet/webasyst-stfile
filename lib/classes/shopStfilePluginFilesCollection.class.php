<?php
class shopStfilePluginFilesCollection 
{
	protected $hash;
	protected $model;
	protected $fields = [];
    ...
    {
		$this->hash = $hash;
		$this->model = new shopStfilePluginFileModel();
	...
	public function workupItems(&$items = array())
    {
		...
		$base_url = wa()->getDataUrl('plugins/stfile/', true, 'shop', false);
		foreach($items as $key => $item) 
		{
			$file_url = $item['id'].'.'.$item['ext'];
